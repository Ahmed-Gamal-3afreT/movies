  ...
  <div class='image'>
    <div class='wrapper'>
      <a class='image' href='movie.php/?id={$result->id}' title='{$result->original_title}'>
              <img loading='lazy' class='poster' src='{$img}' srcset='{$img} 1x, {$img} 2x' alt=''>
...
?>
    ...
    <div id="pagination_page_<?php echo $page; ?>" data-next-page="<?php echo $page+1; ?>" data-current-page="<?php echo $page; ?>" class="pagination infinite background_color light_blue">
      ...
      <p class="load_more"><a class="no_click load_more" data-next-page="<?php echo $page+1; ?>" data-current-page="<?php echo $page; ?>" href="/movies/top_rated.php?page=<?php echo $page+1; ?>">Load More</a></p>
    </div>
</div>
